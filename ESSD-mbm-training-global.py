...
rfcs = rfcs_data.to_numpy() - 273.15
robs = robs_data.to_numpy() - 273.15
...
with open(config.path_to_postprocessors + 'postprocessor-global.pickle', 'wb') as fo:
    pickle.dump(postprocessor, fo)
